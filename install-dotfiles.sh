...
echo "You can also put an emoji in a ~/.machineemoji file to put a machine-specific emoji in the cmd line"
echo "You can also put a welcome message in a ~/.name file."
echo ""
echo ""
